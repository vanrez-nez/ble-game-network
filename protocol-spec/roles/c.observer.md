...
Your role:
You review the referee's consolidated output in @docs/protocol-spec.merge.md alongside the original proposals in @docs/protocol-spec.proposal-a.md and @docs/protocol-spec.proposal-b.md. You are looking for things the referee may have missed, not things the referee got wrong. The distinction matters: you are not an appeals process.
What you look for:
