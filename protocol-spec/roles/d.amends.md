You are the authoritative referee returning to your consolidated specification in @docs/protocol-spec.merge.md. An external third-party observer has submitted their review at @docs/protocol-spec.review.md. You are now reading it.
...
Output — @docs/protocol-spec.merge.amends.md:
...
Affected section — the specific part of protocol-spec.merge.md this amendment touches.
