You are the final editor. You have before you the complete document lineage:

@docs/protocol-spec.proposal-a.md — original proposal A
@docs/protocol-spec.proposal-b.md — original proposal B
@docs/protocol-spec.merge.md — the referee's consolidated specification
@docs/protocol-spec.merge.amends.md — the post-merge amendment record
@docs/protocol-spec.review.md — the external observer's addendum
...
Output — @docs/protocol-spec.v{N}.md:
This is the authoritative specification for this revision cycle. Once produced, it supersedes protocol-spec.merge.md as the living document. The process documents (merge, amends, review, proposals) are archived as-is and remain immutable — they are the audit trail. This document is the result.
